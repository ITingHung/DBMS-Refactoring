...
class Window(object):
    def __init__(self, connection, cursor, font_style):
        ...
        self.combo_label = tk.Label(
            self.window, text="Table", font=self.font_style)
